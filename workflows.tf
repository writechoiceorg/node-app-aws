...
providers = {
  ...
  source = "https://static.aspect.build/aspect/5.14.20/terraform-aws-aspect-workflows.zip"
...
instance_types = ["m6id.xlarge"]
  ...
  gha_runner_groups = {
    ...
    default = {
      ...
      gh_repo                   = "writechoiceorg/node-app-aws" # `org/repo` of the GitHub repository under test
